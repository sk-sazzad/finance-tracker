...
object DatabaseMigrations {
    ...
    // Migration 6 → 7: Add walletId to debt_entries
    val MIGRATION_6_7 = object : Migration(6, 7) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL("ALTER TABLE debt_entries ADD COLUMN `walletId` INTEGER DEFAULT NULL")
        }
    }

    // Migration 7 → 8: Drop exchange rates table.
