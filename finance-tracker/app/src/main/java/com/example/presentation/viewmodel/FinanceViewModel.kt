...
class FinanceViewModel(
    ...
    fun addDebtEntry(personId: Long, amount: Double, reason: String, date: Long) {
        viewModelScope.launch {
    ...
    fun payEntryAmountWithWallet(entry: DebtEntryEntity, amount: Double, walletId: Long) {
        viewModelScope.launch {
            repository.payDebtEntryWithWallet(entry, amount, walletId)
        }
    }
